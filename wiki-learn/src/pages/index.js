  ...
  {movies.map((movie) => (
    ...
    >
      <Link href={"/movie/" + movie._id}>
        <img
          className="p-2 w-[95%] h-96 rounded-t-lg block mx-auto"
          src="https://upload.wikimedia.org/wikipedia/commons/c/c5/Wikimedia_Cote_d_Ivoire_logo.svg"
          alt="WickimediaCIV image"
        />
      </Link>
